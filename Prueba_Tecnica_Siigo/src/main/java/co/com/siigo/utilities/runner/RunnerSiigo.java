package co.com.siigo.utilities.runner;
 ...
 *  @sice 01/11/2019
 * */
public class RunnerSiigo extends Runner {
  private static final Logger LOGGER = LogManager.getLogger(RunnerSiigo.class.getName());
  private Class<CucumberWithSerenity> classValue;
  private CucumberWithSerenity cucumberWithSerenity;

  public RunnerSiigo(Class<CucumberWithSerenity> classValue)
